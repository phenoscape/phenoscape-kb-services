...
object TaxonPhenotypeAnnotation {
      ...
      res => {
        AnnotationSource(
          MinimalTerm(
            ...
            Some(res.getLiteral("pub_label").getLexicalForm)
          ),
  ...
  val ComboTaxonPhenotypeAnnotationMarshaller =
    Marshaller.oneOf(AnnotationTSVMarshaller, JSONResultItem.marshaller)
