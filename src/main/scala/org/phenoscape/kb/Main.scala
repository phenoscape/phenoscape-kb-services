...
object Main extends HttpApp with App {
  ...
  implicit val IRIUnmarshaller: Unmarshaller[String, IRI] =
    Unmarshaller.strict(IRI.create)

  implicit val QualitySpecUnmarshaller: Unmarshaller[String, QualitySpec] =
    IRIUnmarshaller.map(QualitySpec.fromIRI)
  ...
  implicit val OWLNamedIndividualUnmarshaller
      : Unmarshaller[String, OWLNamedIndividual] =
    Unmarshaller.strict(text => factory.getOWLNamedIndividual(IRI.create(text)))

  implicit val SimpleMapFromJSONString
      : Unmarshaller[String, Map[String, String]] = Unmarshaller.strict {
    text =>
      text.parseJson match {
        case o: JsObject =>
          o.fields.map { case (key, value) => key -> value.toString }
        case _ =>
          throw new IllegalArgumentException(s"Not a valid JSON map: $text")
      }
  }
      ...
      Future.fromTry {
        Try {
          ...
          case NonFatal(_) =>
            ...
            Try(
              throw new Unmarshaller.UnsupportedContentTypeException(
  ...
  implicit val comboIRISeqUnmarshaller: Unmarshaller[String, Seq[IRI]] = {
    Unmarshaller.firstOf(
      SeqFromJSONString.map(_.map(IRI.create)),
      IRISeqUnmarshaller
    )
  }

  val cacheKeyer: PartialFunction[
    RequestContext,
    (Uri, Option[HttpHeader], HttpMethod)
  ] = {
    ...
    alwaysCache(memoryCache, cacheKeyer) {
      respondWithHeaders(RawHeader("Vary", "negotiate, Accept")) {
        rejectEmptyResponse {
          pathSingleSlash {
            redirect(
              Uri("http://kb.phenoscape.org/apidocs/"),
            ...
            pathPrefix("term") {
              path("search") {
                  ...
                  (
                    ...
                    complete {
                      val props = properties.getOrElse(
                        List(
                          rdfsLabel,
                          hasExactSynonym.getIRI,
                          hasNarrowSynonym.getIRI,
                          hasBroadSynonym.getIRI
                        )
                      )
                ...
                path("search_classes") {
                  parameters('text, 'definedBy.as[IRI], 'limit.as[Int].?(0)) {
                    (text, definedBy, limit) =>
                      complete {
                        import org.phenoscape.kb.JSONResultItem.JSONResultItemsMarshaller
                ...
                path("classification") {
                  parameters('iri.as[IRI], 'definedBy.as[IRI].?) {
                    (iri, source) =>
                      complete {
                ...
                path("least_common_subsumers") {
                  parameters('iris.as[Seq[IRI]], 'definedBy.as[IRI].?) {
                    (iris, source) =>
                      complete {
                ...
                path("all_ancestors") {
                  parameters('iri.as[IRI], 'parts.as[Boolean].?(false)) {
                    (iri, includeAsPart) =>
                      complete {
                ...
                pathPrefix("property_neighbors") {
                  path("object") {
                    parameters('term.as[IRI], 'property.as[IRI]) {
                      (term, property) =>
                        complete {
                  ...
                  parameters('expression) { (expression) =>
                    complete {
                      Term.resolveLabelExpression(expression) match {
                        ...
                        case Failure(error) =>
                          StatusCodes.UnprocessableEntity -> error
                      }
                    }
                  }
                } ~
              ...
              get {
                parameters(
                  ...
                  respondWithHeader(
                    ...
                    complete {
                      PresenceAbsenceOfStructure.presenceAbsenceMatrix(
                        entity,
                        taxon,
                        variableOnly,
                        includeParts
              ...
              path("query") {
                parameters(
                  ...
                  complete {
                    import org.phenoscape.kb.JSONResultItem.JSONResultItemsMarshaller
                    Similarity
                      .querySimilarProfiles(query, corpusGraph, limit, offset)
                  }
                }
              } ~ // why 2 graphs??
                path("best_matches") {
                  parameters(
                    ...
                    complete {
                      import org.phenoscape.kb.JSONResultItem.JSONResultItemsMarshaller
                      Similarity.bestAnnotationsMatchesForComparison(
                        queryItem,
                        queryGraph,
                        corpusItem,
                        corpusGraph
                ...
                path("best_subsumers") {
                  parameters(
                    ...
                    complete {
                      import org.phenoscape.kb.JSONResultItem.JSONResultItemsMarshaller
                      Similarity.bestSubsumersForComparison(
                        queryItem,
                        corpusItem,
                        corpusGraph
                      )
                ...
                path("subsumed_annotations") {
                  parameters(
                    'subsumer.as[OWLClass],
                    'instance.as[OWLNamedIndividual]
                  ) { (subsumer, instance) =>
                    complete {
                ...
                path("frequency") {
                  get {
                    ...
                    parameters('terms.as[Seq[IRI]], 'corpus_graph.as[IRI]) {
                      (iris, corpusIRI) =>
                        complete {
                    ...
                    post {
                      formFields('terms.as[Seq[IRI]], 'corpus_graph.as[IRI]) {
                        (iris, corpusIRI) =>
                          complete {
                            import Similarity.TermFrequencyTable.TermFrequencyTableCSV
                            Similarity.frequency(iris.toSet, corpusIRI)
              ...
              path("search") { //undocumented and currently unused
                ...
                path("query") { //undocumented and currently unused
                  parameters(
                    ...
                    complete {
                      import org.phenoscape.kb.JSONResultItem.JSONResultItemsMarshaller
                      if (total)
                        CharacterDescription.queryTotal(entity, taxon, Nil)
                      else
                        CharacterDescription
                          .query(entity, taxon, Nil, limit, offset)
                    }
                  }
                } ~
                path("with_annotation") { //undocumented and currently unused
                  parameter('iri.as[IRI]) { iri =>
                    complete {
                      CharacterDescription
                        .annotatedCharacterDescriptionWithAnnotation(iri)
                    }
                  }
                }
            } ~
              ...
              path("phenotypes") {
                  ...
                  (
                    ...
                    complete {
                      ...
                      if (entityIsNamed && qualityIsNamed) {
                        ...
                        if (total)
                          Taxon
                            .directPhenotypesTotalForExpression(
                              taxon,
                              entityOpt,
                              qualityOpt,
                              includeParts,
                          ...
                          Taxon.directPhenotypesForExpression(
                            taxon,
                            entityOpt,
                            qualityOpt,
                            includeParts,
                ...
                path("variation_profile") {
                  parameters(
                    ...
                    'offset.as[Int].?(0),
                    'total.as[Boolean].?(false)
                  ) { (taxon, limit, offset, total) =>
                    complete {
                      import org.phenoscape.kb.JSONResultItem.JSONResultItemsMarshaller
                      if (total)
                        Taxon
                          .variationProfileTotalFor(taxon)
                          .map(ResultCount(_))
                  ...
                  parameters(
                    ...
                    (
                      ...
                      complete {
                        import org.phenoscape.kb.JSONResultItem.JSONResultItemsMarshaller
                        val qualitySpec =
                          qualitySpecOpt.getOrElse(PhenotypicQuality(None))
                        facetBy match {
                          case "entity" =>
                            Taxon.facetTaxaWithPhenotypeByEntity(
                              entityOpt,
                              qualitySpec,
                              taxonOpt,
                              pubOpt,
                          ...
                          case "quality" =>
                            Taxon.facetTaxaWithPhenotypeByQuality(
                              qualitySpec.asOptionalQuality,
                              entityOpt,
                              taxonOpt,
                              pubOpt,
                              includeParts,
                          ...
                          case "taxon" =>
                            Taxon.facetTaxaWithPhenotypeByTaxon(
                              taxonOpt,
                              entityOpt,
                              qualitySpec,
                              pubOpt,
                    ...
                    (
                      ...
                      complete {
                        ...
                        facetBy match {
                          ...
                          case "quality" =>
                            TaxonPhenotypeAnnotation
                              .facetTaxonAnnotationsByQuality(
                                qualitySpec.asOptionalQuality,
                                entityOpt,
                                taxonOpt,
                                pubOpt,
                        ...
                        complete {
                          ...
                          if (total) {
                            ...
                            if (limit > 0 && limit < 1000) {
                              ...
                              TaxonPhenotypeAnnotation.queryAnnotations(
                                entity,
                                qualitySpec,
                                taxonOpt,
                                phenotypeOpt,
                              ...
                              contentType.mediaType match {
                                case MediaTypes.`application/json` =>
                                  implicit val jsonStreaming =
                                    JSONResultItem.jsonStreamingSupport
                                  implicit val jsonMarshaller
                                      : ToByteStringMarshaller[JSONResultItem] =
                                    Marshaller.withFixedContentType(
                                      MediaTypes.`application/json`.toContentType
                                    ) { j =>
                                      ByteString(j.toJSON.toString)
                                    }
                                  TaxonPhenotypeAnnotation
                                    .queryAnnotationsStream(
                                      entity,
                                      qualitySpec,
                                      taxonOpt,
                                      phenotypeOpt,
                  ...
                  parameters('taxon.as[IRI], 'phenotype.as[IRI]) {
                    (taxon, phenotype) =>
                      complete {
                        import org.phenoscape.kb.JSONResultItem.JSONResultItemsMarshaller
                        TaxonPhenotypeAnnotation
                          .annotationSources(taxon, phenotype)
                      }
                  }
                } ~
                path("with_rank") {
                  parameters('rank.as[IRI], 'in_taxon.as[IRI]) {
                    (rank, inTaxon) =>
                      complete {
              ...
              path("search") {
                ...
                pathPrefix("absence") {
                  path("evidence") {
                    parameters(
                      ...
                      'offset.as[Int].?(0),
                      'total.as[Boolean].?(false)
                    ) { (taxon, entity, limit, offset, totalOnly) =>
                      complete {
                        import org.phenoscape.kb.JSONResultItem.JSONResultItemsMarshaller
                        if (totalOnly)
                          PresenceAbsenceOfStructure
                            .statesEntailingAbsenceTotal(taxon, entity)
                            .map(ResultCount(_))
                        else
                          PresenceAbsenceOfStructure.statesEntailingAbsence(
                            taxon,
                            entity,
                            limit,
                            offset
                    ...
                    pathEnd {
                      parameters(
                        ...
                        'offset.as[Int].?(0),
                        'total.as[Boolean].?(false)
                      ) { (entity, taxonFilter, limit, offset, totalOnly) =>
                        complete {
                          import Taxon.ComboTaxaMarshaller
                          if (totalOnly)
                            PresenceAbsenceOfStructure
                            ...
                            PresenceAbsenceOfStructure.taxaExhibitingAbsence(
                              entity,
                              taxonFilter,
                              limit = limit,
                              offset = offset
                  ...
                  path("evidence") {
                    parameters(
                      ...
                      complete {
                        ...
                        if (totalOnly)
                          PresenceAbsenceOfStructure
                            .statesEntailingPresenceTotal(taxon, entity)
                            .map(ResultCount(_))
                        else
                          PresenceAbsenceOfStructure.statesEntailingPresence(
                            taxon,
                            entity,
                            limit,
                            offset
                      ...
                      parameters(
                        ...
                        complete {
                          ...
                          if (totalOnly)
                            ...
                            PresenceAbsenceOfStructure.taxaExhibitingPresence(
                              entity,
                              taxonFilter,
                              limit = limit,
                              offset = offset
                ...
                path("dependency") {
                  get {
                    parameters('terms.as[Seq[IRI]]) { iris =>
                      complete {
                        AnatomicalEntity.presenceAbsenceDependencyMatrix(
                          iris.toList
                        )
                      }
                    }
                    ...
                    complete {
                      ...
                      if (total)
                        GenePhenotypeAnnotation
                          .queryAnnotationsTotal(entity, quality, taxonOpt)
                          .map(ResultCount(_))
                      else
                        GenePhenotypeAnnotation.queryAnnotations(
                          entity,
                          quality,
                          taxonOpt,
                          limit,
                    ...
                    complete {
                      ...
                      if (total)
                        GeneExpressionAnnotation
                          .queryAnnotationsTotal(entity, taxonOpt)
                          .map(ResultCount(_))
                      else
                        GeneExpressionAnnotation
                          .queryAnnotations(entity, taxonOpt, limit, offset)
                    }
                  }
                } ~
                    ...
                    (
                      ...
                      complete {
                        ...
                        if (total)
                          ...
                          Gene.affectingPhenotypeOfEntity(
                            iri,
                            quality,
                            includeParts,
                            includeHistoricalHomologs,
                ...
                path("expressed_within_entity") {
                  parameters(
                    ...
                    complete {
                      import Gene.ComboGenesMarshaller
                      if (total)
                        Gene.expressedWithinEntityTotal(iri).map(ResultCount(_))
                  ...
                  parameters(
                    ...
                    (
                      ...
                      complete {
                        ...
                        facetBy match {
                          case "entity" =>
                            Gene.facetGenesWithPhenotypeByEntity(
                              entityOpt,
                              qualityOpt,
                              includeParts,
                              includeHistoricalHomologs,
                          ...
                          case "quality" =>
                            Gene.facetGenesWithPhenotypeByQuality(
                              qualityOpt,
                              entityOpt,
                              includeParts,
                              includeHistoricalHomologs,
                ...
                path("taxa") {
                  parameters(
                    ...
                    complete {
                      import Taxon.ComboTaxaMarshaller
                      if (total)
                        Study.annotatedTaxaTotal(studyIRI).map(ResultCount(_))
                ...
                path("phenotypes") {
                  parameters(
                    ...
                    complete {
                      ...
                      if (total)
                        Study
                          .annotatedPhenotypesTotal(studyIRI)
                          .map(ResultCount(_))
            ...
            pathPrefix("phenotype") {
              path("query") {
                  ...
                  (
                    ...
                    complete {
                      ...
                      if (total)
                        ...
                        Phenotype.queryTaxonPhenotypes(
                          entity,
                          qualitySpec,
                          taxonOpt,
                          phenotypeOpt,
                  ...
                  parameters(
                    ...
                    (
                      ...
                      complete {
                        ...
                        facetBy match {
                          case "entity" =>
                            Phenotype.facetPhenotypeByEntity(
                              entityOpt,
                              qualitySpec,
                              taxonOpt,
                              pubOpt,
                          ...
                          case "quality" =>
                            Phenotype.facetPhenotypeByQuality(
                              qualitySpec.asOptionalQuality,
                              entityOpt,
                              taxonOpt,
                              pubOpt,
                          ...
                          case "taxon" =>
                            Phenotype.facetPhenotypeByTaxon(
                              taxonOpt,
                              entityOpt,
                              qualitySpec,
                              pubOpt,
                ...
                path("info") {
                  parameters(
                    'iri.as[IRI],
                    'annotated_states_only.as[Boolean].?(false)
